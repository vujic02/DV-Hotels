...
const Text = ({containerMargin}) => {
    return (
        ...
        <Container m={containerMargin} w="50%" wM1="100%" flexDir="column" justify="space-around" align="flex-start">
            ...
            <Button m="1% 0" fontS="1.8rem" fontW="400" bor="1px solid var(--white)" bg="transparent" col="var(--white)" p=".7rem 1rem" bgH="var(--white)" colH="var(--aeganBlue)">Register now</Button>
        </Container>
        </Container>
    )
}
